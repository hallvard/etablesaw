...
public class tdt4100n implements Runnable {
  public void run() {
    ...
    final String here = "/Users/hal/java/git/tablesaw/eclipse/tablesaw.ui.examples/src/tablesaw/ui/examples/";
    ...
    final Table sorted = tdt4100.sortOn("studentnr", "year", "-semester");
  ...
  private Column<String> appendColumns(final Table tdt4100, final Table tdt4100n, final short year, final String semester) {
    Column<String> _xblockexpression = null;
    {
      ...
      TablesawExtensions.<String>operator_add(
      ...
      TablesawExtensions.<Integer>operator_add(
      ...
      TablesawExtensions.<Short>operator_add(
      ...
      _xblockexpression = TablesawExtensions.<String>operator_add(
