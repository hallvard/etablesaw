...
public class Test3_tab1 extends TypedTable<Test3_tab1.Row> {
  private final StringColumn nameColumn;
  
  private final DoubleColumn ageColumn;
  
  public Test3_tab1(final String tableName, final StringColumn nameColumn, final DoubleColumn ageColumn) {
  ...
  public Test3_tab1(final String tableName) {
  ...
  public Test3_tab1 emptyCopy() {
    return new Test3_tab1(name(), getNameColumn().emptyCopy(), getAgeColumn().emptyCopy());
  }
  ...
  public static class Row extends tech.tablesaw.api.Row implements Test3_tab1.RowData {
    ...
    private final Test3_tab1 table;
    
    public Row(final Test3_tab1 table) {
      super(table);
      this.table = table;
    }
    
    @Override
    public Test3_tab1.Row next() {
      super.next();
      return this;
    }
    
    public Test3_tab1.Row setName(final String name) {
      table.getNameColumn().set(getRowNumber(), name);
      return this;
    }
    
    public Test3_tab1.Row setAge(final double age) {
      table.getAgeColumn().set(getRowNumber(), age);
      return this;
    }
  }
  
  protected Test3_tab1.Row row() {
    return new Row(this);
  }
  
  public Test3_tab1 append(final Test3_tab1.Row row) {
