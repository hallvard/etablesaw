...
public class PiePlotView extends AbstractPlotView {
	...
	public void createConfigControls(final Composite parent) {
		...
		categorySelector = createColumnSelector("Category: ", parent, null, CategoricalColumn.class);
		numericsSelector = createColumnSelector("Numbers: ", parent, null, NumericColumn.class);
	}
