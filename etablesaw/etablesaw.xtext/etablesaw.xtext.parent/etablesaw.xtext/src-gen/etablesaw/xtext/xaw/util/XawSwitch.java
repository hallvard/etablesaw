...
public class XawSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        XLocalTimeLiteral xLocalTimeLiteral = (XLocalTimeLiteral)theEObject;
        T result = caseXLocalTimeLiteral(xLocalTimeLiteral);
        if (result == null) result = caseXExpression(xLocalTimeLiteral);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case XawPackage.XLOCAL_DATE_LITERAL:
      {
        XLocalDateLiteral xLocalDateLiteral = (XLocalDateLiteral)theEObject;
        T result = caseXLocalDateLiteral(xLocalDateLiteral);
        if (result == null) result = caseXExpression(xLocalDateLiteral);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case XawPackage.XURL_LITERAL:
      {
        XURLLiteral xurlLiteral = (XURLLiteral)theEObject;
        T result = caseXURLLiteral(xurlLiteral);
        if (result == null) result = caseXExpression(xurlLiteral);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>XLocal Time Literal</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>XLocal Time Literal</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseXLocalTimeLiteral(XLocalTimeLiteral object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>XLocal Date Literal</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>XLocal Date Literal</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseXLocalDateLiteral(XLocalDateLiteral object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>XURL Literal</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>XURL Literal</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
