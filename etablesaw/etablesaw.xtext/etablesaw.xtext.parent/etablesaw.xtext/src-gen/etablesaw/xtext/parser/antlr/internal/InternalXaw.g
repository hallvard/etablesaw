	...
	(
		...
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getXawAccess().getTableDefsTableDefParserRuleCall_4_0_0());
					}
					lv_tableDefs_4_0=ruleTableDef
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getXawRule());
						}
			...
			(
				(
					(
						{
							newCompositeNode(grammarAccess.getXawAccess().getExpressionsXExpressionParserRuleCall_4_1_0_0());
						}
						lv_expressions_5_1=ruleXExpression
						{
							if ($current==null) {
								$current = createModelElementForParent(grammarAccess.getXawRule());
							}
						    ...
						    |
						{
							newCompositeNode(grammarAccess.getXawAccess().getExpressionsXVariableDeclarationParserRuleCall_4_1_0_1());
						}
						lv_expressions_5_2=ruleXVariableDeclaration
						{
							if ($current==null) {
								$current = createModelElementForParent(grammarAccess.getXawRule());
							}
			...
			(
				(
					{
						newCompositeNode(grammarAccess.getXawAccess().getMethodsXMethodParserRuleCall_4_2_0());
					}
					lv_methods_6_0=ruleXMethod
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getXawRule());
						}
...
entryRuleTableDef returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTableDefRule()); }
	iv_ruleTableDef=ruleTableDef
	{ $current=$iv_ruleTableDef.current; }
	EOF;

// Rule TableDef
ruleTableDef returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		otherlv_0='table'
		{
			newLeafNode(otherlv_0, grammarAccess.getTableDefAccess().getTableKeyword_0());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getTableDefAccess().getNameValidIDParserRuleCall_1_0());
				}
				lv_name_1_0=ruleValidID
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getTableDefRule());
					}
					set(
						$current,
						"name",
		...
		otherlv_2='{'
		{
			newLeafNode(otherlv_2, grammarAccess.getTableDefAccess().getLeftCurlyBracketKeyword_2());
		}
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getTableDefAccess().getTableColumDefsTableColumnDefParserRuleCall_3_0_0());
					}
					lv_tableColumDefs_3_0=ruleTableColumnDef
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getTableDefRule());
						}
						add(
							$current,
							"tableColumDefs",
							lv_tableColumDefs_3_0,
							"etablesaw.xtext.Xaw.TableColumnDef");
						afterParserOrEnumRuleCall();
					}
				)
			)
			(
				(
					otherlv_4=','
					{
						newLeafNode(otherlv_4, grammarAccess.getTableDefAccess().getCommaKeyword_3_1_0());
					}
				)?
				(
					(
						{
							newCompositeNode(grammarAccess.getTableDefAccess().getTableColumDefsTableColumnDefParserRuleCall_3_1_1_0());
						}
						lv_tableColumDefs_5_0=ruleTableColumnDef
						{
							if ($current==null) {
								$current = createModelElementForParent(grammarAccess.getTableDefRule());
							}
		...
		otherlv_6='}'
		{
			newLeafNode(otherlv_6, grammarAccess.getTableDefAccess().getRightCurlyBracketKeyword_4());
		}
	)
;

// Entry rule entryRuleTableColumnDef
entryRuleTableColumnDef returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTableColumnDefRule()); }
	iv_ruleTableColumnDef=ruleTableColumnDef
	{ $current=$iv_ruleTableColumnDef.current; }
	EOF;

// Rule TableColumnDef
ruleTableColumnDef returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			(
				{
					newCompositeNode(grammarAccess.getTableColumnDefAccess().getTypeJvmTypeReferenceParserRuleCall_0_0());
				}
				lv_type_0_0=ruleJvmTypeReference
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getTableColumnDefRule());
					}
					set(
						$current,
						"type",
		...
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getTableColumnDefAccess().getNameValidIDParserRuleCall_1_0_0());
					}
					lv_name_1_1=ruleValidID
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getTableColumnDefRule());
						}
					...
					{
						newLeafNode(lv_name_1_2, grammarAccess.getTableColumnDefAccess().getNameSTRINGTerminalRuleCall_1_0_1());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getTableColumnDefRule());
						}
						setWithLastConsumed(
							$current,
							"name",
...
@after {
	...
	(
		...
		(
			otherlv_1='<'
			{
				newLeafNode(otherlv_1, grammarAccess.getXMethodAccess().getLessThanSignKeyword_1_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getXMethodAccess().getTypeParametersJvmTypeParameterParserRuleCall_1_1_0());
					}
			...
			(
				otherlv_3=','
				{
					newLeafNode(otherlv_3, grammarAccess.getXMethodAccess().getCommaKeyword_1_2_0());
				}
				(
					(
						{
							newCompositeNode(grammarAccess.getXMethodAccess().getTypeParametersJvmTypeParameterParserRuleCall_1_2_1_0());
						}
			...
			otherlv_5='>'
			{
				newLeafNode(otherlv_5, grammarAccess.getXMethodAccess().getGreaterThanSignKeyword_1_3());
			}
		)?
		(
			(
				{
					newCompositeNode(grammarAccess.getXMethodAccess().getReturnTypeJvmTypeReferenceParserRuleCall_2_0());
				}
		...
		(
			(
				lv_name_7_0=RULE_ID
				{
					newLeafNode(lv_name_7_0, grammarAccess.getXMethodAccess().getNameIDTerminalRuleCall_3_0());
				}
				{
					if ($current==null) {
		...
		otherlv_8='('
		{
			newLeafNode(otherlv_8, grammarAccess.getXMethodAccess().getLeftParenthesisKeyword_4());
		}
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getXMethodAccess().getParametersFullJvmFormalParameterParserRuleCall_5_0_0());
					}
			...
			(
				otherlv_10=','
				{
					newLeafNode(otherlv_10, grammarAccess.getXMethodAccess().getCommaKeyword_5_1_0());
				}
				(
					(
						{
							newCompositeNode(grammarAccess.getXMethodAccess().getParametersFullJvmFormalParameterParserRuleCall_5_1_1_0());
						}
		...
		otherlv_12=')'
		{
			newLeafNode(otherlv_12, grammarAccess.getXMethodAccess().getRightParenthesisKeyword_6());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getXMethodAccess().getBodyXExpressionParserRuleCall_7_0());
				}
				...
				(
					...
					lv_expressions_4_0=ruleTableColumn
					{
						...
						add(
							...
							"expressions",
							lv_expressions_4_0,
							"etablesaw.xtext.Xaw.TableColumn");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_expressions_8_0=ruleInlineTableRow
				{
					...
					add(
						...
						"expressions",
						lv_expressions_8_0,
						"etablesaw.xtext.Xaw.InlineTableRow");
					afterParserOrEnumRuleCall();
				}
			)
		)*
...
@after {
	...
	(
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getTableColumnAccess().getColumnDefTableColumnDefParserRuleCall_1_0());
				}
				lv_columnDef_1_0=ruleTableColumnDef
				{
					if ($current==null) {
		...
		(
			otherlv_2='='
			{
				newLeafNode(otherlv_2, grammarAccess.getTableColumnAccess().getEqualsSignKeyword_2_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getTableColumnAccess().getExpressionXExpressionParserRuleCall_2_1_0());
					}
	...
	(
		...
		(
			...
			(
				otherlv_1='|'
				{
					newLeafNode(otherlv_1, grammarAccess.getInlineTableRowAccess().getVerticalLineKeyword_1_0_0());
				}
				(
					(
						(
							{
								newCompositeNode(grammarAccess.getInlineTableRowAccess().getExpressionsXExpressionParserRuleCall_1_0_1_0_0());
							}
					...
					(
						otherlv_3=','
						{
							newLeafNode(otherlv_3, grammarAccess.getInlineTableRowAccess().getCommaKeyword_1_0_1_1_0());
						}
						(
							(
								{
									newCompositeNode(grammarAccess.getInlineTableRowAccess().getExpressionsXExpressionParserRuleCall_1_0_1_1_1_0());
								}
				...
				otherlv_5='|'
				{
					newLeafNode(otherlv_5, grammarAccess.getInlineTableRowAccess().getVerticalLineKeyword_1_0_2());
				}
			)
		)
	)
...
entryRuleXLocalTimeLiteral returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXLocalTimeLiteralRule()); }
	iv_ruleXLocalTimeLiteral=ruleXLocalTimeLiteral
	{ $current=$iv_ruleXLocalTimeLiteral.current; }
	EOF;

// Rule XLocalTimeLiteral
ruleXLocalTimeLiteral returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getXLocalTimeLiteralAccess().getXLocalTimeLiteralAction_0(),
					$current);
			}
		)
		otherlv_1='@'
		{
			newLeafNode(otherlv_1, grammarAccess.getXLocalTimeLiteralAccess().getCommercialAtKeyword_1());
		}
		(
			(
				lv_hour_2_0=RULE_INT
				{
					newLeafNode(lv_hour_2_0, grammarAccess.getXLocalTimeLiteralAccess().getHourINTTerminalRuleCall_2_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getXLocalTimeLiteralRule());
					}
					setWithLastConsumed(
						$current,
						"hour",
		...
		otherlv_3=':'
		{
			newLeafNode(otherlv_3, grammarAccess.getXLocalTimeLiteralAccess().getColonKeyword_3());
		}
		(
			(
				lv_min_4_0=RULE_INT
				{
					newLeafNode(lv_min_4_0, grammarAccess.getXLocalTimeLiteralAccess().getMinINTTerminalRuleCall_4_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getXLocalTimeLiteralRule());
		...
		(
			otherlv_5=':'
			{
				newLeafNode(otherlv_5, grammarAccess.getXLocalTimeLiteralAccess().getColonKeyword_5_0());
			}
			(
				(
					lv_second_6_0=RULE_INT
					{
						newLeafNode(lv_second_6_0, grammarAccess.getXLocalTimeLiteralAccess().getSecondINTTerminalRuleCall_5_1_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getXLocalTimeLiteralRule());
...
@after {
	...
	(
		...
		{
			newLeafNode(this_INT_0, grammarAccess.getMONTHAccess().getINTTerminalRuleCall_0());
		}
		    |
		this_ID_1=RULE_ID
		{
		...
		{
			newLeafNode(this_ID_1, grammarAccess.getMONTHAccess().getIDTerminalRuleCall_1());
		}
	)
;

// Entry rule entryRuleXLocalDateLiteral
entryRuleXLocalDateLiteral returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXLocalDateLiteralRule()); }
	iv_ruleXLocalDateLiteral=ruleXLocalDateLiteral
	{ $current=$iv_ruleXLocalDateLiteral.current; }
	EOF;

// Rule XLocalDateLiteral
ruleXLocalDateLiteral returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getXLocalDateLiteralAccess().getXLocalDateLiteralAction_0(),
					$current);
			}
		)
		otherlv_1='@'
		{
			newLeafNode(otherlv_1, grammarAccess.getXLocalDateLiteralAccess().getCommercialAtKeyword_1());
		}
		(
			(
				lv_day_2_0=RULE_INT
				{
					newLeafNode(lv_day_2_0, grammarAccess.getXLocalDateLiteralAccess().getDayINTTerminalRuleCall_2_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getXLocalDateLiteralRule());
					}
					setWithLastConsumed(
						$current,
						"day",
		...
		otherlv_3='-'
		{
			newLeafNode(otherlv_3, grammarAccess.getXLocalDateLiteralAccess().getHyphenMinusKeyword_3());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getXLocalDateLiteralAccess().getMonthMONTHParserRuleCall_4_0());
				}
				lv_month_4_0=ruleMONTH
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getXLocalDateLiteralRule());
					}
					set(
						$current,
						"month",
						lv_month_4_0,
						"etablesaw.xtext.Xaw.MONTH");
					afterParserOrEnumRuleCall();
				}
			)
		)
		otherlv_5='-'
		{
			newLeafNode(otherlv_5, grammarAccess.getXLocalDateLiteralAccess().getHyphenMinusKeyword_5());
		}
		(
			(
				lv_year_6_0=RULE_INT
				{
					newLeafNode(lv_year_6_0, grammarAccess.getXLocalDateLiteralAccess().getYearINTTerminalRuleCall_6_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getXLocalDateLiteralRule());
...
entryRuleHOST returns [String current=null]:
	{ newCompositeNode(grammarAccess.getHOSTRule()); }
	iv_ruleHOST=ruleHOST
	{ $current=$iv_ruleHOST.current.getText(); }
	EOF;

// Rule HOST
ruleHOST returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
	...
	(
		(
			...
			{
				newLeafNode(this_ID_0, grammarAccess.getHOSTAccess().getIDTerminalRuleCall_0_0());
			}
			    |
			this_INT_1=RULE_INT
			{
			...
			{
				newLeafNode(this_INT_1, grammarAccess.getHOSTAccess().getINTTerminalRuleCall_0_1());
			}
		)
		(
			kw='.'
			{
				$current.merge(kw);
				newLeafNode(kw, grammarAccess.getHOSTAccess().getFullStopKeyword_1_0());
			}
			(
				this_ID_3=RULE_ID
				{
				...
				{
					newLeafNode(this_ID_3, grammarAccess.getHOSTAccess().getIDTerminalRuleCall_1_1_0());
				}
				    |
				this_INT_4=RULE_INT
				{
...
entryRuleSEGMENT returns [String current=null]:
	{ newCompositeNode(grammarAccess.getSEGMENTRule()); }
	iv_ruleSEGMENT=ruleSEGMENT
	{ $current=$iv_ruleSEGMENT.current.getText(); }
	EOF;

// Rule SEGMENT
ruleSEGMENT returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
	...
	(
		(
			...
			{
				newLeafNode(this_ID_0, grammarAccess.getSEGMENTAccess().getIDTerminalRuleCall_0_0());
			}
			    |
			this_INT_1=RULE_INT
			{
			...
			{
				newLeafNode(this_INT_1, grammarAccess.getSEGMENTAccess().getINTTerminalRuleCall_0_1());
			}
		)
		(
			kw='.'
			{
				$current.merge(kw);
				newLeafNode(kw, grammarAccess.getSEGMENTAccess().getFullStopKeyword_1_0());
			}
			(
				this_ID_3=RULE_ID
				{
				...
				{
					newLeafNode(this_ID_3, grammarAccess.getSEGMENTAccess().getIDTerminalRuleCall_1_1_0());
				}
				    |
				this_INT_4=RULE_INT
				{
				...
				{
					newLeafNode(this_INT_4, grammarAccess.getSEGMENTAccess().getINTTerminalRuleCall_1_1_1());
				}
			)
		)*
	)
...
@after {
	...
	(
		...
		(
			{
				newCompositeNode(grammarAccess.getPATHAccess().getSEGMENTParserRuleCall_1_0());
			}
			this_SEGMENT_1=ruleSEGMENT
			{
				$current.merge(this_SEGMENT_1);
			}
			{
				afterParserOrEnumRuleCall();
			}
			(
				...
				{
					$current.merge(kw);
					newLeafNode(kw, grammarAccess.getPATHAccess().getSolidusKeyword_1_1_0());
				}
				{
					newCompositeNode(grammarAccess.getPATHAccess().getSEGMENTParserRuleCall_1_1_1());
				}
				this_SEGMENT_3=ruleSEGMENT
				{
					$current.merge(this_SEGMENT_3);
				}
				{
					afterParserOrEnumRuleCall();
				}
...
@after {
	...
	(
		...
		{
			newLeafNode(this_INT_1, grammarAccess.getFRAGMENTAccess().getINTTerminalRuleCall_1());
		}
	)
;
...
@after {
	...
	(
		...
		{
			newLeafNode(this_ID_0, grammarAccess.getPARAMAccess().getIDTerminalRuleCall_0());
		}
		kw='='
		{
			$current.merge(kw);
			newLeafNode(kw, grammarAccess.getPARAMAccess().getEqualsSignKeyword_1());
		}
		(
			this_ID_2=RULE_ID
			{
			...
			{
				newLeafNode(this_ID_2, grammarAccess.getPARAMAccess().getIDTerminalRuleCall_2_0());
			}
			    |
			this_INT_3=RULE_INT
			{
			...
			{
				newLeafNode(this_INT_3, grammarAccess.getPARAMAccess().getINTTerminalRuleCall_2_1());
			}
		)
	)
;
...
entryRuleXURLLiteral returns [EObject current=null]@init {
	HiddenTokens myHiddenTokenState = ((XtextTokenStream)input).setHiddenTokens();
}:
	{ newCompositeNode(grammarAccess.getXURLLiteralRule()); }
	iv_ruleXURLLiteral=ruleXURLLiteral
	{ $current=$iv_ruleXURLLiteral.current; }
	EOF;
finally {
...
// Rule XURLLiteral
ruleXURLLiteral returns [EObject current=null]
@init {
	enterRule();
	HiddenTokens myHiddenTokenState = ((XtextTokenStream)input).setHiddenTokens();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getXURLLiteralAccess().getXURLLiteralAction_0(),
					$current);
			}
		)
		(
			otherlv_1='@'
			{
				newLeafNode(otherlv_1, grammarAccess.getXURLLiteralAccess().getCommercialAtKeyword_1_0());
			}
			(
				(
					(
						...
						{
							newLeafNode(lv_url_2_0, grammarAccess.getXURLLiteralAccess().getUrlSTRINGTerminalRuleCall_1_1_0_0());
						}
						{
							if ($current==null) {
								$current = createModelElement(grammarAccess.getXURLLiteralRule());
							}
							setWithLastConsumed(
								$current,
								"url",
				...
				(
					(
						(
							(
								lv_scheme_3_0=RULE_ID
								{
									newLeafNode(lv_scheme_3_0, grammarAccess.getXURLLiteralAccess().getSchemeIDTerminalRuleCall_1_1_1_0_0_0());
								}
								{
									if ($current==null) {
										$current = createModelElement(grammarAccess.getXURLLiteralRule());
						...
						otherlv_4=':'
						{
							newLeafNode(otherlv_4, grammarAccess.getXURLLiteralAccess().getColonKeyword_1_1_1_0_1());
						}
					)?
					(
						otherlv_5='//'
...
@after {
	...
	(
		...
		{
			$current.merge(kw);
			newLeafNode(kw, grammarAccess.getOpMultiAssignAccess().getAmpersandEqualsSignKeyword_7());
		}
		    |
		kw='|='
		{
			$current.merge(kw);
			newLeafNode(kw, grammarAccess.getOpMultiAssignAccess().getVerticalLineEqualsSignKeyword_8());
		}
	)
;
...
@after {
	...
	(
		{
			newCompositeNode(grammarAccess.getXAndExpressionAccess().getXSingleAndExpressionParserRuleCall_0());
		}
...
entryRuleOpSingleOr returns [String current=null]:
	{ newCompositeNode(grammarAccess.getOpSingleOrRule()); }
	iv_ruleOpSingleOr=ruleOpSingleOr
	{ $current=$iv_ruleOpSingleOr.current.getText(); }
	EOF;

// Rule OpSingleOr
ruleOpSingleOr returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleXSingleAndExpression returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXSingleAndExpressionRule()); }
	iv_ruleXSingleAndExpression=ruleXSingleAndExpression
	{ $current=$iv_ruleXSingleAndExpression.current; }
	EOF;

// Rule XSingleAndExpression
ruleXSingleAndExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		{
			newCompositeNode(grammarAccess.getXSingleAndExpressionAccess().getXEqualityExpressionParserRuleCall_0());
		}
		...
		(
			(
				...
				(
					(
						{
							$current = forceCreateModelElementAndSet(
								grammarAccess.getXSingleAndExpressionAccess().getXBinaryOperationLeftOperandAction_1_0_0_0(),
								$current);
						}
					)
					(
						(
							{
								if ($current==null) {
									$current = createModelElement(grammarAccess.getXSingleAndExpressionRule());
								}
							}
							{
								newCompositeNode(grammarAccess.getXSingleAndExpressionAccess().getFeatureJvmIdentifiableElementCrossReference_1_0_0_1_0());
							}
							ruleOpSingleAnd
							{
								afterParserOrEnumRuleCall();
			...
			(
				(
					{
						newCompositeNode(grammarAccess.getXSingleAndExpressionAccess().getRightOperandXEqualityExpressionParserRuleCall_1_1_0());
					}
					lv_rightOperand_3_0=ruleXEqualityExpression
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getXSingleAndExpressionRule());
						}
						set(
							$current,
							"rightOperand",
...
@after {
	...
	(
		...
		{
			$current.merge(kw);
			newLeafNode(kw, grammarAccess.getOpMultiAccess().getQuestionMarkKeyword_4());
		}
	)
;
...
@after {
	...
	(
		...
		this_TableRowLiteral_1=ruleTableRowLiteral
		{
		    ...
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXLocalTimeLiteralParserRuleCall_2());
		}
		this_XLocalTimeLiteral_2=ruleXLocalTimeLiteral
		{
			$current = $this_XLocalTimeLiteral_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXLocalDateLiteralParserRuleCall_3());
		}
		this_XLocalDateLiteral_3=ruleXLocalDateLiteral
		{
			$current = $this_XLocalDateLiteral_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXURLLiteralParserRuleCall_4());
		}
		this_XURLLiteral_4=ruleXURLLiteral
		{
			$current = $this_XURLLiteral_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXCollectionLiteralParserRuleCall_5());
		}
		this_XCollectionLiteral_5=ruleXCollectionLiteral
		{
			$current = $this_XCollectionLiteral_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		(
			...
			{
				newCompositeNode(grammarAccess.getXLiteralAccess().getXClosureParserRuleCall_6());
			}
			this_XClosure_6=ruleXClosure
			{
				$current = $this_XClosure_6.current;
				afterParserOrEnumRuleCall();
			}
		)
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXBooleanLiteralParserRuleCall_7());
		}
		this_XBooleanLiteral_7=ruleXBooleanLiteral
		{
			$current = $this_XBooleanLiteral_7.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXNumberLiteralParserRuleCall_8());
		}
		this_XNumberLiteral_8=ruleXNumberLiteral
		{
			$current = $this_XNumberLiteral_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXNullLiteralParserRuleCall_9());
		}
		this_XNullLiteral_9=ruleXNullLiteral
		{
			$current = $this_XNullLiteral_9.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXStringLiteralParserRuleCall_10());
		}
		this_XStringLiteral_10=ruleXStringLiteral
		{
			$current = $this_XStringLiteral_10.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
			newCompositeNode(grammarAccess.getXLiteralAccess().getXTypeLiteralParserRuleCall_11());
		}
		this_XTypeLiteral_11=ruleXTypeLiteral
		{
			$current = $this_XTypeLiteral_11.current;
			afterParserOrEnumRuleCall();
		}
	)
;
				...
				(
					...
					lv_rightOperand_3_0=ruleXAndExpression
					{
						...
						set(
							...
							"rightOperand",
							lv_rightOperand_3_0,
							"etablesaw.xtext.Xaw.XAndExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
