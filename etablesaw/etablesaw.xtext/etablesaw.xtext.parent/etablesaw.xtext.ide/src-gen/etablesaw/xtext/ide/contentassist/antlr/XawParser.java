 ...
 */
package etablesaw.xtext.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import etablesaw.xtext.ide.contentassist.antlr.internal.InternalXawParser;
...
public class XawParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XawGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getXawAccess().getExpressionsAlternatives_4_1_0(), "rule__Xaw__ExpressionsAlternatives_4_1_0");
			builder.put(grammarAccess.getTableColumnDefAccess().getNameAlternatives_1_0(), "rule__TableColumnDef__NameAlternatives_1_0");
			...
			builder.put(grammarAccess.getHOSTAccess().getAlternatives_1_1(), "rule__HOST__Alternatives_1_1");
			builder.put(grammarAccess.getSEGMENTAccess().getAlternatives_0(), "rule__SEGMENT__Alternatives_0");
			builder.put(grammarAccess.getSEGMENTAccess().getAlternatives_1_1(), "rule__SEGMENT__Alternatives_1_1");
			...
			builder.put(grammarAccess.getTableDefAccess().getGroup(), "rule__TableDef__Group__0");
			builder.put(grammarAccess.getTableDefAccess().getGroup_3(), "rule__TableDef__Group_3__0");
			builder.put(grammarAccess.getTableDefAccess().getGroup_3_1(), "rule__TableDef__Group_3_1__0");
			builder.put(grammarAccess.getTableColumnDefAccess().getGroup(), "rule__TableColumnDef__Group__0");
			builder.put(grammarAccess.getXMethodAccess().getGroup(), "rule__XMethod__Group__0");
			builder.put(grammarAccess.getXMethodAccess().getGroup_1(), "rule__XMethod__Group_1__0");
			builder.put(grammarAccess.getXMethodAccess().getGroup_1_2(), "rule__XMethod__Group_1_2__0");
			builder.put(grammarAccess.getXMethodAccess().getGroup_5(), "rule__XMethod__Group_5__0");
			builder.put(grammarAccess.getXMethodAccess().getGroup_5_1(), "rule__XMethod__Group_5_1__0");
			...
			builder.put(grammarAccess.getTableColumnAccess().getGroup_2(), "rule__TableColumn__Group_2__0");
			builder.put(grammarAccess.getInlineTableRowAccess().getGroup(), "rule__InlineTableRow__Group__0");
			builder.put(grammarAccess.getInlineTableRowAccess().getGroup_1(), "rule__InlineTableRow__Group_1__0");
			builder.put(grammarAccess.getInlineTableRowAccess().getGroup_1_0(), "rule__InlineTableRow__Group_1_0__0");
			builder.put(grammarAccess.getInlineTableRowAccess().getGroup_1_0_1(), "rule__InlineTableRow__Group_1_0_1__0");
			builder.put(grammarAccess.getInlineTableRowAccess().getGroup_1_0_1_1(), "rule__InlineTableRow__Group_1_0_1_1__0");
			...
			builder.put(grammarAccess.getXLocalTimeLiteralAccess().getGroup(), "rule__XLocalTimeLiteral__Group__0");
			builder.put(grammarAccess.getXLocalTimeLiteralAccess().getGroup_5(), "rule__XLocalTimeLiteral__Group_5__0");
			builder.put(grammarAccess.getXLocalDateLiteralAccess().getGroup(), "rule__XLocalDateLiteral__Group__0");
			...
			builder.put(grammarAccess.getSEGMENTAccess().getGroup_1(), "rule__SEGMENT__Group_1__0");
			...
			builder.put(grammarAccess.getXURLLiteralAccess().getGroup(), "rule__XURLLiteral__Group__0");
			builder.put(grammarAccess.getXURLLiteralAccess().getGroup_1(), "rule__XURLLiteral__Group_1__0");
			...
			builder.put(grammarAccess.getXSingleOrExpressionAccess().getGroup(), "rule__XSingleOrExpression__Group__0");
			builder.put(grammarAccess.getXSingleOrExpressionAccess().getGroup_1(), "rule__XSingleOrExpression__Group_1__0");
			builder.put(grammarAccess.getXSingleOrExpressionAccess().getGroup_1_0(), "rule__XSingleOrExpression__Group_1_0__0");
			builder.put(grammarAccess.getXSingleOrExpressionAccess().getGroup_1_0_0(), "rule__XSingleOrExpression__Group_1_0_0__0");
			builder.put(grammarAccess.getXSingleAndExpressionAccess().getGroup(), "rule__XSingleAndExpression__Group__0");
			builder.put(grammarAccess.getXSingleAndExpressionAccess().getGroup_1(), "rule__XSingleAndExpression__Group_1__0");
			builder.put(grammarAccess.getXSingleAndExpressionAccess().getGroup_1_0(), "rule__XSingleAndExpression__Group_1_0__0");
			builder.put(grammarAccess.getXSingleAndExpressionAccess().getGroup_1_0_0(), "rule__XSingleAndExpression__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getXawAccess().getTableDefsAssignment_4_0(), "rule__Xaw__TableDefsAssignment_4_0");
			builder.put(grammarAccess.getXawAccess().getExpressionsAssignment_4_1(), "rule__Xaw__ExpressionsAssignment_4_1");
			builder.put(grammarAccess.getXawAccess().getMethodsAssignment_4_2(), "rule__Xaw__MethodsAssignment_4_2");
			builder.put(grammarAccess.getTableDefAccess().getNameAssignment_1(), "rule__TableDef__NameAssignment_1");
			builder.put(grammarAccess.getTableDefAccess().getTableColumDefsAssignment_3_0(), "rule__TableDef__TableColumDefsAssignment_3_0");
			builder.put(grammarAccess.getTableDefAccess().getTableColumDefsAssignment_3_1_1(), "rule__TableDef__TableColumDefsAssignment_3_1_1");
			builder.put(grammarAccess.getTableColumnDefAccess().getTypeAssignment_0(), "rule__TableColumnDef__TypeAssignment_0");
			builder.put(grammarAccess.getTableColumnDefAccess().getNameAssignment_1(), "rule__TableColumnDef__NameAssignment_1");
			builder.put(grammarAccess.getXMethodAccess().getTypeParametersAssignment_1_1(), "rule__XMethod__TypeParametersAssignment_1_1");
			builder.put(grammarAccess.getXMethodAccess().getTypeParametersAssignment_1_2_1(), "rule__XMethod__TypeParametersAssignment_1_2_1");
			builder.put(grammarAccess.getXMethodAccess().getReturnTypeAssignment_2(), "rule__XMethod__ReturnTypeAssignment_2");
			builder.put(grammarAccess.getXMethodAccess().getNameAssignment_3(), "rule__XMethod__NameAssignment_3");
			builder.put(grammarAccess.getXMethodAccess().getParametersAssignment_5_0(), "rule__XMethod__ParametersAssignment_5_0");
			builder.put(grammarAccess.getXMethodAccess().getParametersAssignment_5_1_1(), "rule__XMethod__ParametersAssignment_5_1_1");
			builder.put(grammarAccess.getXMethodAccess().getBodyAssignment_7(), "rule__XMethod__BodyAssignment_7");
			...
			builder.put(grammarAccess.getTableColumnAccess().getColumnDefAssignment_1(), "rule__TableColumn__ColumnDefAssignment_1");
			builder.put(grammarAccess.getTableColumnAccess().getExpressionAssignment_2_1(), "rule__TableColumn__ExpressionAssignment_2_1");
			builder.put(grammarAccess.getInlineTableRowAccess().getExpressionsAssignment_1_0_1_0(), "rule__InlineTableRow__ExpressionsAssignment_1_0_1_0");
			builder.put(grammarAccess.getInlineTableRowAccess().getExpressionsAssignment_1_0_1_1_1(), "rule__InlineTableRow__ExpressionsAssignment_1_0_1_1_1");
			...
			builder.put(grammarAccess.getXLocalTimeLiteralAccess().getHourAssignment_2(), "rule__XLocalTimeLiteral__HourAssignment_2");
			builder.put(grammarAccess.getXLocalTimeLiteralAccess().getMinAssignment_4(), "rule__XLocalTimeLiteral__MinAssignment_4");
			builder.put(grammarAccess.getXLocalTimeLiteralAccess().getSecondAssignment_5_1(), "rule__XLocalTimeLiteral__SecondAssignment_5_1");
			builder.put(grammarAccess.getXLocalDateLiteralAccess().getDayAssignment_2(), "rule__XLocalDateLiteral__DayAssignment_2");
			builder.put(grammarAccess.getXLocalDateLiteralAccess().getMonthAssignment_4(), "rule__XLocalDateLiteral__MonthAssignment_4");
			...
			builder.put(grammarAccess.getXSingleOrExpressionAccess().getRightOperandAssignment_1_1(), "rule__XSingleOrExpression__RightOperandAssignment_1_1");
			builder.put(grammarAccess.getXSingleAndExpressionAccess().getFeatureAssignment_1_0_0_1(), "rule__XSingleAndExpression__FeatureAssignment_1_0_0_1");
			builder.put(grammarAccess.getXSingleAndExpressionAccess().getRightOperandAssignment_1_1(), "rule__XSingleAndExpression__RightOperandAssignment_1_1");
